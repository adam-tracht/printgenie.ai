...
const AboutSection = () => {
  ...
  return (
    ...
    <div id="about-section" className="mt-8 max-w-6xl mx-auto p-6 bg-gray-800 rounded-lg shadow-xl">
      ...
      <section className="mb-12 md:mb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8">
          {steps.map((step, index) => (
            <div key={index} className="bg-gray-900 rounded-lg p-4 md:p-6 shadow-lg flex flex-col items-center text-center">
              {step.icon}
