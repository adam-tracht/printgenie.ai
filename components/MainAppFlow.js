...
const Hero = () => (
  <div className="text-center mb-8">
    ...
    Create one-of-a-kind artwork printed on your choice of canvas.    </h1>
    <p className="md:text-lg text-gray-300 max-w-3xl mx-auto mb-6">
      Each piece is uniquely generated by leading edge AI image generation software and printed on demand.
    </p>
  </div>
);
